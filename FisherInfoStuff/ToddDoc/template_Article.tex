...
%
%Is $\boldsymbol{u_h}$ akin to the tangent space of robot and goal locations?!! 
%
%In Miller et al. both $\alpha$ and $x$ belong to the same space. However, in my case, $u_h$ and $x_r, x_g$ belong to different spaces (Is $u_h$ in the tangent space of the robot and goal positions?)
